...
export declare class VillainsController {
    ...
    retrieveVillain(id: string): Promise<import("./villain.interface").VillainInterface>;
    saveVillain(res: any, villainDto: CreateVillainDto): Promise<any>;
    updateVillain(id: string, villainDto: CreateVillainDto): Promise<import("./villain.interface").VillainInterface>;
